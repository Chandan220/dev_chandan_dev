          ...
          <div className="home_div_main_feed">
            ...
            <div className="wrapper">
              <div className="leftside_home_div">
                ...
                <p className="looking">
                  With a solid foundation in the MERN stack, a commitment to
                  best coding practices, and a passion for continuous learning,
                  I am well-equipped to contribute to innovative and high-impact
                  projects as a MERN Full Stack Developer. I am eager to bring
                  my technical expertise and collaborative approach to a dynamic
                  development team.
                  {/* <br class="looking_br" /> 
                <br class="looking_br" /> */}
                </p>
